...
namespace NextIteration.SpectreConsole.Auth.Providers.GitHub.Tests
{
    ...
    {
        [Fact]
        public void ProviderName_IsGitHub() => Assert.Equal("GitHub", GitHubCredential.ProviderName);

        [Fact]
        public void SupportedEnvironments_AreEnumNames() => Assert.Equal(["GitHubCom", "Enterprise"], GitHubCredential.SupportedEnvironments);
